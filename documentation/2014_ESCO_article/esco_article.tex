...
\author[pe]{Pavel Exner}
\ead[pe]{pavel.exner@tul.cz}
...
We follow the work of R.~Gracie and J.R.~Craig \cite{gracie}.

\section{Adaptive integration}
\label{sec:adaptive_integration}

The price for using enrichment functions and a coarse mesh are higher requirements on integration precision.
We need to deal with integration of enrichment functions which can be non-polynomial, as in our case. 
The standard quadrature rules are not appropriate now, as they are constructed to integrate precisely 
polynomials up to given degree.
