...
\textcolor{structure}{$\boldsymbol{\star}$}~{\bf\large ESCO '14, Plze\v n}
}
...
%          106   (25)  & 74   & 34   & 27  & 90    (9)    \\ \hline
%          358   (69)  & 246  & 65   & 55  & 326   (37)   \\ \hline
%          1274  (185) & 959  & 124  & 102 & 1218  (129)  \\ \hline
%          4838  (613) &  *   & 248  & 201 & 4734  (509)  \\ \hline
%          18910 (2269)&  *   & 466  & 412 & 18702 (2061) \\ \bottomrule 
%          74710 (8661)&  *   & 866  & 847 & 74294 (8045) \\ \bottomrule 
%     \end{tabular}
%   \end{table}
%   
%   -- CG tolerance set $10^{-12}$, Jacobi preconditioner applied \newline
%   * did not converged after 1000 iterations.
%   
% \end{frame}

% \begin{frame}[c]
%   \frametitle{Solving linear system}
%   scaled condition number: $\mathfrak{K}(A)=\kappa(H),\, H=DAD, \, D_{ii}=A_{ii}^{-1/2} $
%   \begin{table}
%     \centering
%     \small
%     %\begin{tabular} { >{\color{black}}m{2.0cm} | *3{>{\color{black}}m{1.3cm}} | >{\color{black}}m{2.0cm} }
%     \begin{tabular} { >{\color{black}}m{2.0cm} >{\color{black}}m{1.3cm} | >{\color{black}}m{1.3cm} | >{\color{black}}m{1.3cm}  >{\color{black}}m{1.0cm} }
%       \toprule
%        \multicolumn{5}{c}{scaled condition number} \\
%       \toprule 
%          size & XFEM \newline ramp, shift & FEM part & SGFEM & size \\ \toprule
%          107  & 166.4   & 8.9    & 15.4  & 91    \\ \hline
%          359  & 330.9   & 41.8   & 72.0  & 327   \\ \hline
%          1275 & 535.8   & 216.4  & 356.8 & 1219  \\ \hline
%          4839 & 1877.6  & 1013.6 & 1987.4 & 4735  \\ \hline
%     \end{tabular}
%   \end{table}
%   
%   \begin{itemize}
%     \item condition numbers computed in Matlab by \texttt{cond()} function \\
%     \item SGFEM should yield $\mathfrak{K}(A_{SGFEM})\approx \mathfrak{K}(A_{FEM})$ (not recognized yet)
%   \end{itemize}
%   
% \end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=0.85\textwidth]{\results sin_solution.pdf}
  %\vspace{5pt}
...
\begin{frame}[c]
  ...
  \hspace{-15pt}
  \begin{minipage}{0.8\linewidth}
    \includegraphics[width=1.1\linewidth]{\results sin_convergence_graph.pdf}
  \end{minipage}
  \hspace{-5pt}
  \begin{minipage}{0.23\linewidth}
    \vspace{30pt}  
